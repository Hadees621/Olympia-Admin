    ...
    return (
        <div className="pb-4 pt-0 shadow-md w-full">
            ...
            <div className="flex justify-between mt-4 px-4">
                <Button title={"Previous"} text={"text-white"} bg='bg-gray-500' hover='hover:bg-gray-600' width={"w-[130px]"} onClick={prev} />
                <Button title={"Submit Now"} text={"text-white"} bg='bg-green-600' hover='hover:bg-green-700' width={"w-[130px]"} />
            </div>
        </div>
    )
}
