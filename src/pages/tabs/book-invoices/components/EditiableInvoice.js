    ...
    <div className="space-y-6 p-4">
      ...
      <div className="flex p-4 px-6 shadow">
        <div className="text-md font-semibold w-[65%]">
          ...
          <p className="mb-2">
            PAY BY BANK TRANSFER USING OUR BANK DETAILS BELOW
          </p>
          <p>Lloyds Bank</p>
          ...
          <p>
            Please make payment to our PayPal at accounts@olympiapublishers.com
          </p>

          <p className="mt-4">
            Please ensure we receive your remittance with this section before
            the due date.
          </p>
          <p>
            Interest will be charged on all overdue invoices at a rate of 1% per
            day.
          </p>

          <p className="mt-6 text-red-500 font-normal italic">
            Olympia Publishers, Tallis House, 2 Tallis Street, London, EC4Y 0AB,
            United Kingdom
          </p>
        </div>
